# REST API and Cisco DNA Center [![published](https://static.production.devnetcloud.com/codeexchange/assets/images/devnet-published.svg)](https://developer.cisco.com/codeexchange/github/repo/kebaldwi/DNAC-TEMPLATES)
...
## How are REST API used with Cisco DNA Center?
...
5. Integrating DNA Center with other systems, such as IT service management (ITSM) platforms, security information and event management (SIEM) systems, and cloud orchestration platforms.

6. Building custom applications and integrations that leverage the capabilities of DNA Center to meet specific business needs.

Overall, **REST APIs** with Cisco DNA Center can help simplify network management, reduce operational costs, and improve network performance and security.

## What types of API Integrations are there?

### Cisco DNA Center Built in REST API Integrations

Cisco DNA Center has several built-in integrations that use REST APIs, including:

1. **Cisco Identity Services Engine (ISE)**: ISE is a network access control (NAC) platform that can be integrated with DNA Center to enforce network access policies. The integration uses **REST APIs** to exchange information about network devices, users, and policies.

2. **Cisco Stealthwatch**: Stealthwatch is a network security platform that can be integrated with DNA Center to monitor network traffic and detect security threats. The integration uses **REST APIs** to exchange information about network flows, devices, and events.
...
### Published REST API for Cisco DNA Center

Cisco DNA Center has a comprehensive set of published **REST APIs** that allow developers to programmatically interact with the platform. Some of the key published APIs include:
...
Overall, using Developer Mode on Chrome can be a helpful tool for troubleshooting **REST API** issues and gaining a better understanding of how Cisco DNA Center's APIs work.
...
To get started developing **REST API** with Cisco DNA Center, you will need to:

1. Obtain access to a Cisco DNA Center instance and obtain credentials to authenticate API requests.

2. Familiarize yourself with the Cisco DNA Center **REST API** documentation, which can be found within Cisco DNA Center's **Developer Toolkit** or alternatively on the [**Cisco DevNet website**](https://developer.cisco.com/docs/dna-center/).

3. Choose a *programming language* or *toolset* that you are comfortable with, and use it to send **HTTP requests** to Cisco DNA Center. Some examples of toolsets include an **IDE** like [**Visual Studio**](https://code.visualstudio.com/download), or [**Sublime**](https://www.sublimetext.com/) and [**Postman**](https://www.postman.com/downloads/) for code creation and testing.
...
6. Finally, consider joining the [**Cisco DevNet community**](https://developer.cisco.com/site/coi/) to connect with other developers and access additional resources and support for developing with Cisco DNA Center APIs.

## Building Production Code with REST API for Cisco DNA Center

To build production ready code for **REST API** for Cisco DNA Center, it's important to follow best practices for software development and API usage. Here are some general steps to consider:
...
7. Monitor your API usage and performance using tools like Cisco DNA Center's analytics and reporting capabilities.
...
Overall, building production code for **REST API** for Cisco DNA Center requires a disciplined approach to software development and API usage, as well as a commitment to security, performance, and usability.
...
1. **Simplified API calls**: The SDK provides a simple and intuitive interface for making **REST API** calls to Cisco DNA Center, reducing the amount of code required to build integrations.

2. **Object-oriented design**: The SDK uses an object-oriented design, with Python classes and methods that map to DNA Center's **REST API** resources, making it easier to work with complex data structures.
...
4. **Authentication**: The SDK includes built-in support for authenticating API requests using DNA Center's token-based authentication mechanism.
...
Overall, the Cisco DNA Center Python SDK can help simplify the process of building **REST API** integrations with DNA Center and reduce the amount of time and effort required to develop robust and reliable integrations.

## Labs Overview

We include in the Repository a full set of Labs designed to help customers with varying challenges in Automating and Orchestrating their network infrastructure. Within the lab, we will use a complete set of **REST API** collections which will build upon the foundational knowledge. For this lab, we concentrate on DNA Center configuration and how DNA Center can be orchestrated via **REST API** to perform various functions: 
