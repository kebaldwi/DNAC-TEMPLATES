...
2. Although you can manually set up the hierarchy we will use an automation script to implement the hierarchy using dnacentercli utility.

```
export DNA_CENTER_USERNAME='devnetuser'
export DNA_CENTER_PASSWORD='Cisco123!'
export DNA_CENTER_BASE_URL='https://xxx.com'
