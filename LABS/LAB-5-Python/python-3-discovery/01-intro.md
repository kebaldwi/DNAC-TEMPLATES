...
In this module, we will use **Python** to discover devices within the network and **assign** them to specific sites within the hierarchy within Cisco Catalyst Center.  
