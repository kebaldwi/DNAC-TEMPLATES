# Device Inventory Python Pipeline

In this section of the tutorial, we will continue using a simple REST-API set, which has been grouped into a **Python** program. We will then construct a Jenkins Pipeline to automate the inventory retrieval from Cisco Catalyst Center.
...
```
   ...
   2. As you scroll through the lines of the program take note of the following:
      ...
      - **definitions** functions are defined to build API interactions 
        ...
        ![json](./images/inventory-python.png?raw=true "Import JSON")
...
1. To create a new **Pipeline** job: 
   ...
   4. Click **OK**.
      ...
      ![json](./images/Jenkins_Item_Inventory.png?raw=true "Import JSON")
...
4. Within the **Pipeline** just created and on the left click **Pipeline**. This will scroll to the **Pipeline Script** section. 
   ...
   ![json](./images/Jenkins_Item_Inventory_pipeline.png?raw=true "Import JSON")
