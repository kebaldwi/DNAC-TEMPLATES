...
## DCLOUD as a LAB
### Overview
This section will explain which lab to utilize within the **DCLOUD** environment to run these LAB's. It will also discuss a customer POC environemnt and what can be done to successfully run these sections within a customer enviroment for localized testing.
