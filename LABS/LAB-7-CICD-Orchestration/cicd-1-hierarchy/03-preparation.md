...
We will utilize the Python program **deploy_hierarchy.py** to build out the Hierarchy of Catalyst Center into which we later will associate **settings** and **discover devices**. 
